...
${OBJECTDIR}/Export_f_B_only.o: Export_f_B_only.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Export_f_B_only.o Export_f_B_only.cpp

${OBJECTDIR}/GF_SE.o: GF_SE.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GF_SE.o GF_SE.cpp
...
${OBJECTDIR}/export_b_q_only.o: export_b_q_only.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/export_b_q_only.o export_b_q_only.cpp

${OBJECTDIR}/hilbert_space.o: hilbert_space.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hilbert_space.o hilbert_space.cpp
...
${OBJECTDIR}/multi_index_aux.o: multi_index_aux.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/multi_index_aux.o multi_index_aux.cpp
